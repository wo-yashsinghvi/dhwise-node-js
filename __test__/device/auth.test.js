...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Jacey_Lockman32',
      password: 'BMAz4aq6bwvEOPI',
      email: 'Dayana_Pollich@yahoo.com',
      name: 'Tasha McKenzie',
      userType: 421,
      mobileNo: '(373) 228-6216',
      resetPasswordLink: {},
      loginRetryLimit: 889,
      loginReactiveTime: '2024-05-07T06:05:10.864Z',
      id: '658314b31b94eb082502eeb9'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Rafaela47',
        'password':'AbQ1jnOpj5iSe5h',
        'email':'Frieda25@gmail.com',
        'name':'Miss Nellie Greenfelder',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(141) 985-1372',
