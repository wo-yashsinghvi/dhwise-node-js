...
async function seedUser () {
  try {
    ...
    let user = await dbService.updateOne(User, { 'username':'Antone.Dietrich' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'565wQ53nT5UF9cR',
      'isDeleted':false,
      'username':'Einar91',
      'email':'Daisy.Howe76@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Einar91' }, userToBeInserted,  { upsert: true });
